...
<!-- <h1>Room Catagory</h1> -->
<!-- <div>
<button style="float:right;" href="" type="button" class="btn btn-primary">add </button>
<button style="float:right;" href="" type="button" class="btn btn-primary">edit</button>
<button style="float:right;" href="" type="button" class="btn btn-primary">delect</button>
<div> -->
<!-- <form>
  <div class="mb-3">
...
<div class="col-md-6">
									<div class="card">
										...
										<div class="card-header">
											<div class="card-title"><h1>Add Catagory<h1></div>
										</div>
										<div class="card-body">
											<div>
												<!-- <button class="btn btn-success">edit</button>
											<button class="btn btn-success">add</button>
											<button class="btn btn-delect">delect</button>
									 -->
											<div class="form-group">
												<label for="squareInput">Catagory Tilte</label>
												<input type="text" class="form-control input-square" id="squareInput" placeholder="Square Input">
											</div>
											<div class="form-group">
												<label for="squareSelect">Description</label>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control input-pill" id="pillInput" placeholder="Price">
											</div>
											<!-- <div class="form-group">
